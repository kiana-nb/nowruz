...
export default function page() {
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center gap-10 bg-[url('/watercolor-bg2.svg')] w-screen h-dvh bg-no-repeat bg-cover relative overflow-hidden">
      <section className="flex flex-col items-center justify-center gap-8 px-[34px]">
        ...
        <div className="flex flex-col items-center justify-center rounded-[28px] border border-[#76AE6C] bg-white px-3 py-8 text-[#355E2A]">
        ...
        <Link href="/badges" className="rounded-full bg-[#F5772D] px-6 py-5 text-sm font-normal text-white">
